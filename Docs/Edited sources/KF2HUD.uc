...
defaultproperties
{
     ...
     TinG=180
     TinB=255
     KF2Font=Font'FPPHUD.KF2Font'
     KF2Digits=(DigitTexture=Texture'FPPHUDAssets.KF2DigitTex',TextureCoords[0]=(X1=15,Y1=8,X2=68,Y2=82),TextureCoords[1]=(X1=89,Y1=8,X2=115,Y2=82),TextureCoords[2]=(X1=137,Y1=8,X2=192,Y2=82),TextureCoords[3]=(X1=210,Y1=8,X2=260,Y2=82),TextureCoords[4]=(X1=279,Y1=8,X2=331,Y2=82),TextureCoords[5]=(X1=353,Y1=8,X2=399,Y2=82),TextureCoords[6]=(X1=424,Y1=8,X2=470,Y2=82),TextureCoords[7]=(X1=494,Y1=8,X2=540,Y2=82),TextureCoords[8]=(X1=561,Y1=8,X2=610,Y2=82),TextureCoords[9]=(X1=631,Y1=8,X2=680,Y2=82),TextureCoords[10]=(X1=686,Y1=8,X2=726,Y2=82))
     KF2BLBase=(WidgetTexture=Texture'FPPHUDAssets.KF2BL_base',RenderStyle=STY_Alpha,TextureCoords=(X2=512,Y2=256),TextureScale=0.700000,PosX=0.015000,PosY=0.935000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=128),Tints[1]=(B=255,G=255,R=255,A=128))
     KF2BLScan=(WidgetTexture=Texture'FPPHUDAssets.KF2BL_scanline',RenderStyle=STY_Alpha,TextureCoords=(X2=512,Y2=256),TextureScale=0.700000,PosX=0.015000,PosY=0.935000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=255),Tints[1]=(B=255,G=255,R=255,A=255))
     KF2BLOverlay=(WidgetTexture=Texture'FPPHUDAssets.KF2BL_xpover',RenderStyle=STY_Alpha,TextureCoords=(X2=512,Y2=256),TextureScale=0.700000,PosX=0.015000,PosY=0.935000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=160),Tints[1]=(B=255,G=255,R=255,A=255))
     KF2HealthIcon=(WidgetTexture=Texture'FPPHUDAssets.kf2ui_cross',RenderStyle=STY_Alpha,TextureCoords=(X2=512,Y2=256),TextureScale=0.100000,PosX=0.015000,PosY=0.935000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=128),Tints[1]=(B=255,G=255,R=255,A=128))
     KF2ArmorIcon=(WidgetTexture=Texture'FPPHUDAssets.kf2ui_shield',RenderStyle=STY_Alpha,TextureCoords=(X2=512,Y2=256),TextureScale=0.100000,PosX=0.015000,PosY=0.935000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=128),Tints[1]=(B=255,G=255,R=255,A=128))
     KF2SyringeIcon=(WidgetTexture=Texture'FPPHUDAssets.kf2ui_syringe',RenderStyle=STY_Alpha,TextureCoords=(X2=512,Y2=256),TextureScale=0.150000,PosX=0.015000,PosY=0.935000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=255),Tints[1]=(B=255,G=255,R=255,A=128))
     KF2NadeIcon=(WidgetTexture=Texture'FPPHUDAssets.kf2ui_nade',RenderStyle=STY_Alpha,TextureCoords=(X2=512,Y2=256),TextureScale=0.100000,PosX=0.015000,PosY=0.935000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=128),Tints[1]=(B=255,G=255,R=255,A=128))
     KF2BRBase=(WidgetTexture=Texture'FPPHUDAssets.KF2BR_base',RenderStyle=STY_Alpha,TextureCoords=(X2=512,Y2=256),TextureScale=0.700000,PosX=0.015000,PosY=0.935000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=128),Tints[1]=(B=255,G=255,R=255,A=128))
     KF2BRScan=(WidgetTexture=Texture'FPPHUDAssets.KF2BR_scanline',RenderStyle=STY_Alpha,TextureCoords=(X2=512,Y2=256),TextureScale=0.700000,PosX=0.015000,PosY=0.935000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=255),Tints[1]=(B=255,G=255,R=255,A=255))
     KF2BROverlay=(WidgetTexture=Texture'FPPHUDAssets.KF2BR_overlay',RenderStyle=STY_Alpha,TextureCoords=(X2=512,Y2=256),TextureScale=0.700000,PosX=0.015000,PosY=0.935000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=255),Tints[1]=(B=255,G=255,R=255,A=255))
     KF2BRAngle=(WidgetTexture=Texture'FPPHUDAssets.KF2BR_angle',RenderStyle=STY_Alpha,TextureCoords=(X2=512,Y2=256),TextureScale=0.700000,PosX=0.015000,PosY=0.935000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=255),Tints[1]=(B=255,G=255,R=255,A=255))
     KF2BRMelee=(WidgetTexture=Texture'FPPHUDAssets.KF2BR_melee',RenderStyle=STY_Alpha,TextureCoords=(X2=512,Y2=256),TextureScale=0.700000,PosX=0.015000,PosY=0.935000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=255),Tints[1]=(B=255,G=255,R=255,A=255))
     KF2DoshIcon=(WidgetTexture=Texture'FPPHUDAssets.kf2ui_dosh',RenderStyle=STY_Alpha,TextureCoords=(X2=512,Y2=256),TextureScale=0.100000,PosX=0.015000,PosY=0.935000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=128),Tints[1]=(B=255,G=255,R=255,A=128))
     KF2WeightIcon=(WidgetTexture=Texture'FPPHUDAssets.kf2ui_weight',RenderStyle=STY_Alpha,TextureCoords=(X2=512,Y2=256),TextureScale=0.100000,PosX=0.015000,PosY=0.935000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=128),Tints[1]=(B=255,G=255,R=255,A=128))
     KF2BatteryIcon=(WidgetTexture=Texture'FPPHUDAssets.kf2ui_battery',RenderStyle=STY_Alpha,TextureCoords=(X2=512,Y2=256),TextureScale=0.150000,PosX=0.015000,PosY=0.935000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=255),Tints[1]=(B=255,G=255,R=255,A=128))
     KF2AltBase=(WidgetTexture=Texture'FPPHUDAssets.KF2BR_basealt',RenderStyle=STY_Alpha,TextureCoords=(X2=512,Y2=256),TextureScale=0.700000,PosX=0.015000,PosY=0.935000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=128),Tints[1]=(B=255,G=255,R=255,A=128))
     KF2AltScan=(WidgetTexture=Texture'FPPHUDAssets.KF2BR_scanlinealt',RenderStyle=STY_Alpha,TextureCoords=(X2=512,Y2=256),TextureScale=0.700000,PosX=0.015000,PosY=0.935000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=255),Tints[1]=(B=255,G=255,R=255,A=255))
     ...
     KF2TLBase=(WidgetTexture=Texture'FPPHUDAssets.KF2TL_base',RenderStyle=STY_Alpha,TextureCoords=(X2=512,Y2=256),TextureScale=0.500000,PosX=0.015000,PosY=0.935000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=128),Tints[1]=(B=255,G=255,R=255,A=128))
     KF2TLScan=(WidgetTexture=Texture'FPPHUDAssets.KF2TL_scanline',RenderStyle=STY_Alpha,TextureCoords=(X2=512,Y2=256),TextureScale=0.700000,PosX=0.015000,PosY=0.935000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=255),Tints[1]=(B=255,G=255,R=255,A=128))
     KF2TLOverlay=(WidgetTexture=Texture'FPPHUDAssets.KF2TL_redline',RenderStyle=STY_Alpha,TextureCoords=(X2=512,Y2=256),TextureScale=0.700000,PosX=0.015000,PosY=0.935000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=100,G=44,R=26,A=255),Tints[1]=(B=255,G=255,R=255,A=128))
     KF2TLSquare=(WidgetTexture=Texture'FPPHUDAssets.KF2TL_square',RenderStyle=STY_Alpha,TextureCoords=(X2=512,Y2=256),TextureScale=0.500000,PosX=0.015000,PosY=0.935000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=192),Tints[1]=(B=255,G=255,R=255,A=128))
     KF2TLClock=(WidgetTexture=Texture'FPPHUDAssets.kf2ui_clock',RenderStyle=STY_Alpha,TextureCoords=(X2=512,Y2=256),TextureScale=0.100000,PosX=0.015000,PosY=0.935000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=128),Tints[1]=(B=255,G=255,R=255,A=128))
     KF2TLZed=(WidgetTexture=Texture'FPPHUDAssets.kf2ui_zed',RenderStyle=STY_Alpha,TextureCoords=(X2=512,Y2=256),TextureScale=0.100000,PosX=0.015000,PosY=0.935000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=128),Tints[1]=(B=255,G=255,R=255,A=128))
     ...
     ArrowScale=0.500000
     ArrowUp=Texture'FPPHUDAssets.KF2TL_arrowup'
     ArrowDown=Texture'FPPHUDAssets.KF2TL_arrowdown'
     ...
     KillDampen=0.850000
     KillBG=Texture'FPPHUDAssets.kf2ui_kill'
     SkullIcon=Texture'FPPHUDAssets.kf2ui_skull'
     ...
     WaveCompleteSound=Sound'FPPHUDAssets.kf2mid_wavecomplete'
     WaveBeginSound=Sound'FPPHUDAssets.kf2mid_waveincoming'
     MidWarnTex=Texture'FPPHUDAssets.kf2mid_caution'
     MidSolidTex=Texture'FPPHUDAssets.kf2mid_solid'
     MidLeftTex=Texture'FPPHUDAssets.kf2mid_left'
     MidRightTex=Texture'FPPHUDAssets.kf2mid_right'
     ...
     BBLeft=Texture'FPPHUDAssets.kf2bb_left'
     BBMid=Texture'FPPHUDAssets.kf2bb_middle'
     BBRight=Texture'FPPHUDAssets.kf2bb_right'
     BBSkull=Texture'FPPHUDAssets.kf2bb_skull'
